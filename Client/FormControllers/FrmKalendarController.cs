...
namespace Client.FormControllers
{
    public class FrmKalendarController
    {
        ...
        internal void UcitajTermine()
        {
            ...
            // prikazi samo listu termina ciji je datum ispred trenutnog
            termini = new BindingList<Termin>(listaTerminaSaServera.Where(t => t.DatumVremeTermina > DateTime.Now).ToList()); 
            ;
        }
